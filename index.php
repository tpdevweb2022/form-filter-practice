...
$postalCode = filter_var($_POST["postal_code"], FILTER_SANITIZE_NUMBER_INT);
$passOk = $_POST["password"] === $_POST["confirmPassword"]; // sort true ou false
    ...
    <form action="" method="POST">
      <div class="container">
        ...
        <div class="row d-flex justify-content-between py-3">
          ...
          <div class="col-12 col-md-5">
            <div class="form-floating mb-3">
              <input type="password" class="form-control" name="confirmPassword" id="confirmPassword" required placeholder="Confirmer mot de passe" />
        ...
        <div class="row d-flex justify-content-between py-3">
          <div class="col-12 col-md-6">
            ...
            <div class="d-flex flex-wrap">
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="velo" name="loisirs[]" id="VeloCB" />
                <label class="form-check-label" for="VeloCB"> Vélo </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="foot" name="loisirs[]" id="FootCB" />
                <label class="form-check-label" for="FootCB"> Foot </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="canape" name="loisirs[]" id="CanapeCB" />
                <label class="form-check-label" for="CanapeCB">
                  Canapé
                </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="barbecue" name="loisirs[]" id="BarbecueCB" />
                <label class="form-check-label" for="BarbecueCB">
                  Barbecue
                </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="peche" id="pecheCB" name="loisirs[]" />
                <label class="form-check-label" for="pecheCB"> Pêche </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="karate" id="karateCB" name="loisirs[]" />
                <label class="form-check-label" for="karateCB">
                  Karaté
                </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="randonee" id="randoneeCB" name="loisirs[]" />
                <label class="form-check-label" for="randoneeCB">
                  Randonnée
                </label>
              </div>
              <div class="form-check my-1" style="width: 50%">
                <input class="form-check-input" type="checkbox" value="vaccine" id="vaccineCB" name="loisirs[]" />
          ...
          <div class="col-12 col-md-6 pt-3 pt-md-0">
            ...
            <div>
              <textarea name="other" class="form-control" id="other" rows="5" placeholder="Autres informations"></textarea>
            </div>
          </div>
        </div>
        <div class="row">
